...
public class EjecutarEjercicio567 {

	public static void	ejercicio1() {
		
		int	edades[];
		
		Main567.num = MetodAux.menuOpciones("¿Desea introducir las edades manualmente?", null, "Indique su respuesta");
	...
	private static int	leerEdad() {
		...
		do {
			...
			if (MetodAux.checkSoloNumeroPositivoEntero()) {
				...
				edad = Integer.parseInt(Main567.entrada);
